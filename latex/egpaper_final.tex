...
outputs \cite{reservoir}, or reparameterize the codebook, as in SimVQ \cite{simvq},
...
loss.\footnote{Our quantizer implementations build on the
\texttt{vector-quantize-pytorch} library~\cite{lucidrains_vqpytorch}.}
